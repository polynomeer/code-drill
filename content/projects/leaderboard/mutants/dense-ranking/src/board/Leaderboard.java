...
// 동점 뒤의 순위를 건너뛰지 않는다 (1, 2, 2, 3). 경쟁 순위는 1, 2, 2, 4 다.
public class Leaderboard {
    ...
    private int rankOf(long score) {
        java.util.Set<Long> higher = new java.util.HashSet<>();
        for (long other : scores.values()) if (other > score) higher.add(other);
